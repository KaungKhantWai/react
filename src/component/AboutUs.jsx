export default function About() {
  return (
    <section className="flex flex-col md:flex-row items-center gap-12 px-6 md:px-16 py-16 md:py-24"
      ...
      <div className="w-full md:w-1/2">
        ...
        {/* Small label */}
        <span className="text-xs uppercase tracking-widest font-medium mb-4 block"
